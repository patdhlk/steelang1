...
Constants["Class"] = SteelangClass.new                 # Defining the `Class` class.
Constants["Class"].runtime_class = Constants["Class"] # Setting `Class.class = Class`.
Constants["Object"] = SteelangClass.new                # Defining the `Object` class
Constants["Number"] = SteelangClass.new                # Defining the `Number` class
Constants["String"] = SteelangClass.new
...
# to have a class too.
Constants["TrueClass"] = SteelangClass.new
Constants["FalseClass"] = SteelangClass.new
Constants["NilClass"] = SteelangClass.new
